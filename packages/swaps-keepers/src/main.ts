...
import PriceFeed, { UpdateResult, UpdateResultPrimary } from "./services/priceFeed";
...
const logResult = (message: string, result: UpdateResult | UpdateResultPrimary) => {
